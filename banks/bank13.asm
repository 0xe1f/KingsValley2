...
;  Packed lists: gems / actors / tools / screens / links / pickups / doors
;  (macros in objects.inc).
;  Consumers: a75d / aae0 / afb1 / adcf-af37 / b7cd / b8f8 / b9ad / ba57 /
;  bb38 / bcbb. Screen bits @ 0xAB5A. Vic spawn @ 0xB844. Exit door @ 0xB8F8.
;  print_stream: legend @ 0xBC54; names through 0xBECF.
;  Leftover INCBIN: map bits + RLE @ 0xBB3C, tiles @ 0xBECF (copy_tiles
;  0xBF36 / 0xBFC6; SAT base 0xBECF). Trailing 0xFF pad from 0xBFF6.
;  .blocks map: banks/bank13.blocks
; ===========================================================================

; (org set by PHASE in KingsValley2.asm)
	INCLUDE "banks/bank13.gems.inc"
	INCLUDE "banks/bank13.actors.inc"
	INCLUDE "banks/bank13.screens.inc"
	INCLUDE "banks/bank13.links.inc"
afb1_tbl:                         ; per-pyramid map tools -> 0xE300 (load_map_tools; 60 words, level-1)
	...
	INCLUDE "banks/bank13.tools.inc"
	INCLUDE "banks/bank13.pickups.inc"
	INCLUDE "banks/bank13.doors.inc"
bb38_tbl:
	defw 0bb3ch, 0bb9ch
	INCBIN "banks/bank13.tbl.bin", 0, 0x118          ; 0xBB3C-0xBC54 map bits + RLE
...
names_tools:                      ; max=5; knife, boomerang, shovel (HUD scoop), pick, hammer, drill
	...
	TEXT "right password"
	TEXT_END
	INCBIN "banks/bank13.tbl.bin", 0x118         ; 0xBECF-0xBFF6 tiles
	ds 10, 0ffh
